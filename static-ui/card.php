...
<?php require_once("lib/header.php");?>
	...
	<body class="card">
		<div class="panel panel-default">
			<div class="panel-body row" >
				...
				<div class="col-md-4">
					<h2>Violations</h2>
					<ul>
						<li><i class="fa fa-hand-spock-o" aria-hidden="true"></i></li>
						<li><i class="fa fa-cutlery" aria-hidden="true"></i></li>
					</ul>
					<button type="button" class="btn btn-primary active">Learn More</button>
				</div>
			</div>
		</div>
		<!--2nd panel -->
		...
		<div class="panel panel-default">
			<div class="panel-body row" >
				<div class="col-md-4">
					<img class="img-responsive" src="images/mexican.jpg">
				</div>
				<div class="col-md-4">
					<h1>Federicos</h1>
					<p>1524 West Elm st. SW ALbuquerque,NM 87104</p> <br>
